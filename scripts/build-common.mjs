...
fs.writeFileSync(
  ...
  JSON.stringify(
    yaml.parse(fs.readFileSync("pkg/vars/common/subject_staffs.yml", "utf-8"), { maxAliasCount: -1 }),
    null,
    2,
  ),
);
...
fs.writeFileSync(
  ...
  JSON.stringify(
    yaml.parse(fs.readFileSync("pkg/vars/common/subject_relations.yml", "utf-8"), { maxAliasCount: -1 }),
    null,
    2,
  ),
);
