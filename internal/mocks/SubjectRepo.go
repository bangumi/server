...
func (_m *SubjectRepo) Get(ctx context.Context, id model.SubjectID) (model.Subject, error) {
...
//  - ctx context.Context
//  - id model.SubjectID
func (_e *SubjectRepo_Expecter) Get(ctx any, id any) *SubjectRepo_Get_Call {
...
func (_m *SubjectRepo) GetActors(ctx context.Context, subjectID model.SubjectID, characterIDs ...model.CharacterID) (map[model.CharacterID][]model.Person, error) {
...
func (_e *SubjectRepo_Expecter) GetActors(ctx any, subjectID any, characterIDs ...any) *SubjectRepo_GetActors_Call {
...
func (_c *SubjectRepo_GetActors_Call) Return(_a0 map[model.CharacterID][]model.Person, _a1 error) *SubjectRepo_GetActors_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

// GetByIDs provides a mock function with given fields: ctx, ids
func (_m *SubjectRepo) GetByIDs(ctx context.Context, ids ...model.SubjectID) (map[model.SubjectID]model.Subject, error) {
...
//  - ctx context.Context
//  - ids ...model.SubjectID
func (_e *SubjectRepo_Expecter) GetByIDs(ctx any, ids ...any) *SubjectRepo_GetByIDs_Call {
	return &SubjectRepo_GetByIDs_Call{Call: _e.mock.On("GetByIDs",
		append([]any{ctx}, ids...)...)}
}

func (_c *SubjectRepo_GetByIDs_Call) Run(run func(ctx context.Context, ids ...model.SubjectID)) *SubjectRepo_GetByIDs_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_e *SubjectRepo_Expecter) GetCharacterRelated(ctx any, characterID any) *SubjectRepo_GetCharacterRelated_Call {
...
func (_e *SubjectRepo_Expecter) GetPersonRelated(ctx any, personID any) *SubjectRepo_GetPersonRelated_Call {
...
//  - ctx context.Context
//  - subjectID model.SubjectID
func (_e *SubjectRepo_Expecter) GetSubjectRelated(ctx any, subjectID any) *SubjectRepo_GetSubjectRelated_Call {
