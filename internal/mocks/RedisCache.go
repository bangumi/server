...
import (
	...
	cache "github.com/bangumi/server/internal/cache"
...
func (_m *RedisCache) GetMany(ctx context.Context, keys []string) cache.GetManyResult {
	ret := _m.Called(ctx, keys)

	var r0 cache.GetManyResult
	if rf, ok := ret.Get(0).(func(context.Context, []string) cache.GetManyResult); ok {
		r0 = rf(ctx, keys)
	} else {
		r0 = ret.Get(0).(cache.GetManyResult)
	}

	return r0
}

// RedisCache_GetMany_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetMany'
type RedisCache_GetMany_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - keys []string
func (_e *RedisCache_Expecter) GetMany(ctx interface{}, keys interface{}) *RedisCache_GetMany_Call {
	return &RedisCache_GetMany_Call{Call: _e.mock.On("GetMany", ctx, keys)}
}

func (_c *RedisCache_GetMany_Call) Run(run func(ctx context.Context, keys []string)) *RedisCache_GetMany_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RedisCache_GetMany_Call) Return(_a0 cache.GetManyResult) *RedisCache_GetMany_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// SetMany provides a mock function with given fields: ctx, data, ttl
func (_m *RedisCache) SetMany(ctx context.Context, data map[string]interface{}, ttl time.Duration) error {
...
// RedisCache_SetMany_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetMany'
type RedisCache_SetMany_Call struct {
	*mock.Call
}
...
//   - ttl time.Duration
func (_e *RedisCache_Expecter) SetMany(ctx interface{}, data interface{}, ttl interface{}) *RedisCache_SetMany_Call {
	return &RedisCache_SetMany_Call{Call: _e.mock.On("SetMany", ctx, data, ttl)}
}

func (_c *RedisCache_SetMany_Call) Run(run func(ctx context.Context, data map[string]interface{}, ttl time.Duration)) *RedisCache_SetMany_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RedisCache_SetMany_Call) Return(_a0 error) *RedisCache_SetMany_Call {
	_c.Call.Return(_a0)
	return _c
}
