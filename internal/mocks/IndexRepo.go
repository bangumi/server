...
// AddIndexComment provides a mock function with given fields: ctx, newComment
func (_m *IndexRepo) AddIndexComment(ctx context.Context, newComment model.IndexComment) error {
	ret := _m.Called(ctx, newComment)

	if len(ret) == 0 {
		panic("no return value specified for AddIndexComment")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, model.IndexComment) error); ok {
...
// IndexRepo_AddIndexComment_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AddIndexComment'
type IndexRepo_AddIndexComment_Call struct {
	*mock.Call
}

// AddIndexComment is a helper method to define mock.On call
//   - ctx context.Context
//   - newComment model.IndexComment
func (_e *IndexRepo_Expecter) AddIndexComment(ctx interface{}, newComment interface{}) *IndexRepo_AddIndexComment_Call {
	return &IndexRepo_AddIndexComment_Call{Call: _e.mock.On("AddIndexComment", ctx, newComment)}
}

func (_c *IndexRepo_AddIndexComment_Call) Run(run func(ctx context.Context, newComment model.IndexComment)) *IndexRepo_AddIndexComment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.IndexComment))
	})
	return _c
}

func (_c *IndexRepo_AddIndexComment_Call) Return(_a0 error) *IndexRepo_AddIndexComment_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *IndexRepo_AddIndexComment_Call) RunAndReturn(run func(context.Context, model.IndexComment) error) *IndexRepo_AddIndexComment_Call {
	_c.Call.Return(run)
	return _c
}
...
// DeleteIndexComment provides a mock function with given fields: ctx, id
func (_m *IndexRepo) DeleteIndexComment(ctx context.Context, id uint32) error {
	ret := _m.Called(ctx, id)

	if len(ret) == 0 {
		panic("no return value specified for DeleteIndexComment")
	}
...
// IndexRepo_DeleteIndexComment_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteIndexComment'
type IndexRepo_DeleteIndexComment_Call struct {
	*mock.Call
}

// DeleteIndexComment is a helper method to define mock.On call
//   - ctx context.Context
//   - id uint32
func (_e *IndexRepo_Expecter) DeleteIndexComment(ctx interface{}, id interface{}) *IndexRepo_DeleteIndexComment_Call {
	return &IndexRepo_DeleteIndexComment_Call{Call: _e.mock.On("DeleteIndexComment", ctx, id)}
}

func (_c *IndexRepo_DeleteIndexComment_Call) Run(run func(ctx context.Context, id uint32)) *IndexRepo_DeleteIndexComment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uint32))
	})
	return _c
...
func (_c *IndexRepo_DeleteIndexComment_Call) Return(_a0 error) *IndexRepo_DeleteIndexComment_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *IndexRepo_DeleteIndexComment_Call) RunAndReturn(run func(context.Context, uint32) error) *IndexRepo_DeleteIndexComment_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetIndexComment provides a mock function with given fields: ctx, id
func (_m *IndexRepo) GetIndexComment(ctx context.Context, id uint32) (*model.IndexComment, error) {
	ret := _m.Called(ctx, id)

	if len(ret) == 0 {
		panic("no return value specified for GetIndexComment")
	}

	var r0 *model.IndexComment
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint32) (*model.IndexComment, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint32) *model.IndexComment); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.IndexComment)
		}
	}
...
// IndexRepo_GetIndexComment_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetIndexComment'
type IndexRepo_GetIndexComment_Call struct {
	*mock.Call
}

// GetIndexComment is a helper method to define mock.On call
//   - ctx context.Context
//   - id uint32
func (_e *IndexRepo_Expecter) GetIndexComment(ctx interface{}, id interface{}) *IndexRepo_GetIndexComment_Call {
	return &IndexRepo_GetIndexComment_Call{Call: _e.mock.On("GetIndexComment", ctx, id)}
}

func (_c *IndexRepo_GetIndexComment_Call) Run(run func(ctx context.Context, id uint32)) *IndexRepo_GetIndexComment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uint32))
	})
	return _c
...
func (_c *IndexRepo_GetIndexComment_Call) Return(_a0 *model.IndexComment, _a1 error) *IndexRepo_GetIndexComment_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *IndexRepo_GetIndexComment_Call) RunAndReturn(run func(context.Context, uint32) (*model.IndexComment, error)) *IndexRepo_GetIndexComment_Call {
	_c.Call.Return(run)
	return _c
}

// GetIndexComments provides a mock function with given fields: ctx, id, offset, limit
func (_m *IndexRepo) GetIndexComments(ctx context.Context, id uint32, offset int, limit int) ([]model.IndexComment, error) {
	ret := _m.Called(ctx, id, offset, limit)

	if len(ret) == 0 {
		panic("no return value specified for GetIndexComments")
	}

	var r0 []model.IndexComment
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint32, int, int) ([]model.IndexComment, error)); ok {
		return rf(ctx, id, offset, limit)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint32, int, int) []model.IndexComment); ok {
...
// IndexRepo_GetIndexComments_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetIndexComments'
type IndexRepo_GetIndexComments_Call struct {
	*mock.Call
}

// GetIndexComments is a helper method to define mock.On call
//   - ctx context.Context
//   - id uint32
//   - offset int
//   - limit int
func (_e *IndexRepo_Expecter) GetIndexComments(ctx interface{}, id interface{}, offset interface{}, limit interface{}) *IndexRepo_GetIndexComments_Call {
	return &IndexRepo_GetIndexComments_Call{Call: _e.mock.On("GetIndexComments", ctx, id, offset, limit)}
}

func (_c *IndexRepo_GetIndexComments_Call) Run(run func(ctx context.Context, id uint32, offset int, limit int)) *IndexRepo_GetIndexComments_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IndexRepo_GetIndexComments_Call) Return(_a0 []model.IndexComment, _a1 error) *IndexRepo_GetIndexComments_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *IndexRepo_GetIndexComments_Call) RunAndReturn(run func(context.Context, uint32, int, int) ([]model.IndexComment, error)) *IndexRepo_GetIndexComments_Call {
	_c.Call.Return(run)
	return _c
}
...
// UpdateIndexComment provides a mock function with given fields: ctx, indexID, comment
func (_m *IndexRepo) UpdateIndexComment(ctx context.Context, indexID uint32, comment string) error {
	ret := _m.Called(ctx, indexID, comment)

	if len(ret) == 0 {
		panic("no return value specified for UpdateIndexComment")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, uint32, string) error); ok {
		r0 = rf(ctx, indexID, comment)
	} else {
		r0 = ret.Error(0)
	}
...
// IndexRepo_UpdateIndexComment_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateIndexComment'
type IndexRepo_UpdateIndexComment_Call struct {
	*mock.Call
}

// UpdateIndexComment is a helper method to define mock.On call
//   - ctx context.Context
//   - indexID uint32
//   - comment string
func (_e *IndexRepo_Expecter) UpdateIndexComment(ctx interface{}, indexID interface{}, comment interface{}) *IndexRepo_UpdateIndexComment_Call {
	return &IndexRepo_UpdateIndexComment_Call{Call: _e.mock.On("UpdateIndexComment", ctx, indexID, comment)}
}

func (_c *IndexRepo_UpdateIndexComment_Call) Run(run func(ctx context.Context, indexID uint32, comment string)) *IndexRepo_UpdateIndexComment_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IndexRepo_UpdateIndexComment_Call) Return(_a0 error) *IndexRepo_UpdateIndexComment_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *IndexRepo_UpdateIndexComment_Call) RunAndReturn(run func(context.Context, uint32, string) error) *IndexRepo_UpdateIndexComment_Call {
	_c.Call.Return(run)
	return _c
}

// WithQuery provides a mock function with given fields: _a0
func (_m *IndexRepo) WithQuery(_a0 *query.Query) index.IndexRepo {
	ret := _m.Called(_a0)
	...
	var r0 index.IndexRepo
	if rf, ok := ret.Get(0).(func(*query.Query) index.IndexRepo); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(index.IndexRepo)
		}
	}
...
// IndexRepo_WithQuery_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WithQuery'
type IndexRepo_WithQuery_Call struct {
	*mock.Call
}

// WithQuery is a helper method to define mock.On call
//   - _a0 *query.Query
func (_e *IndexRepo_Expecter) WithQuery(_a0 interface{}) *IndexRepo_WithQuery_Call {
	return &IndexRepo_WithQuery_Call{Call: _e.mock.On("WithQuery", _a0)}
}

func (_c *IndexRepo_WithQuery_Call) Run(run func(_a0 *query.Query)) *IndexRepo_WithQuery_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IndexRepo_WithQuery_Call) Return(_a0 index.IndexRepo) *IndexRepo_WithQuery_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *IndexRepo_WithQuery_Call) RunAndReturn(run func(*query.Query) index.IndexRepo) *IndexRepo_WithQuery_Call {
	_c.Call.Return(run)
	return _c
}
