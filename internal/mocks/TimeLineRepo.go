...
func (_m *TimeLineRepo) Create(ctx context.Context, tl model.TimeLine) (model.TimeLine, error) {
	ret := _m.Called(ctx, tl)

	var r0 model.TimeLine
	if rf, ok := ret.Get(0).(func(context.Context, model.TimeLine) model.TimeLine); ok {
		r0 = rf(ctx, tl)
	} else {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, model.TimeLine) error); ok {
		r1 = rf(ctx, tl)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *TimeLineRepo_Create_Call) Return(_a0 model.TimeLine, _a1 error) *TimeLineRepo_Create_Call {
