...
func (_m *EpisodeRepo) CountByType(ctx context.Context, subjectID model.SubjectID, epType int16) (int64, error) {
	ret := _m.Called(ctx, subjectID, epType)

	var r0 int64
	if rf, ok := ret.Get(0).(func(context.Context, model.SubjectID, int16) int64); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, model.SubjectID, int16) error); ok {
...
func (_c *EpisodeRepo_CountByType_Call) Run(run func(ctx context.Context, subjectID model.SubjectID, epType int16)) *EpisodeRepo_CountByType_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.SubjectID), args[2].(int16))
	})
	return _c
}
...
// EpisodeRepo_Get_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetByID'
...
func (_e *EpisodeRepo_Expecter) Get(ctx interface{}, episodeID interface{}) *EpisodeRepo_Get_Call {
	return &EpisodeRepo_Get_Call{Call: _e.mock.On("GetByID", ctx, episodeID)}
}
...
func (_m *EpisodeRepo) ListByType(ctx context.Context, subjectID model.SubjectID, epType int16, limit int, offset int) ([]model.Episode, error) {
	ret := _m.Called(ctx, subjectID, epType, limit, offset)

	var r0 []model.Episode
	if rf, ok := ret.Get(0).(func(context.Context, model.SubjectID, int16, int, int) []model.Episode); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, model.SubjectID, int16, int, int) error); ok {
...
func (_c *EpisodeRepo_ListByType_Call) Run(run func(ctx context.Context, subjectID model.SubjectID, epType int16, limit int, offset int)) *EpisodeRepo_ListByType_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.SubjectID), args[2].(int16), args[3].(int), args[4].(int))
	})
	return _c
}
...
type NewEpisodeRepoT interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewEpisodeRepo(t NewEpisodeRepoT) *EpisodeRepo {
	mock := &EpisodeRepo{}
	mock.Mock.Test(t)
