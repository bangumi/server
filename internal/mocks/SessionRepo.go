...
//  - regTime time.Time
//  - keyGen func() string
func (_e *SessionRepo_Expecter) Create(ctx any, userID any, regTime any, keyGen any) *SessionRepo_Create_Call {
...
//  - ctx context.Context
//  - key string
func (_e *SessionRepo_Expecter) Get(ctx any, key any) *SessionRepo_Get_Call {
...
//  - ctx context.Context
//  - key string
func (_e *SessionRepo_Expecter) Revoke(ctx any, key any) *SessionRepo_Revoke_Call {
...
//  - ctx context.Context
//  - userID model.UserID
func (_e *SessionRepo_Expecter) RevokeUser(ctx any, userID any) *SessionRepo_RevokeUser_Call {
