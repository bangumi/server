...
func (_m *PrivateMessageRepo) Create(ctx context.Context, senderID model.UserID, receiverIDs []model.UserID, relatedIDFilter pm.IDFilter, title string, content string) ([]model.PrivateMessage, error) {
	ret := _m.Called(ctx, senderID, receiverIDs, relatedIDFilter, title, content)

	var r0 []model.PrivateMessage
	if rf, ok := ret.Get(0).(func(context.Context, model.UserID, []model.UserID, pm.IDFilter, string, string) []model.PrivateMessage); ok {
