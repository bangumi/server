...
func (_m *PrivateMessageRepo) CountByFolder(ctx context.Context, userID model.UserID, folder pm.FolderType) (int64, error) {
	ret := _m.Called(ctx, userID, folder)

	var r0 int64
	if rf, ok := ret.Get(0).(func(context.Context, model.UserID, pm.FolderType) int64); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, model.UserID, pm.FolderType) error); ok {
...
func (_c *PrivateMessageRepo_CountByFolder_Call) Run(run func(ctx context.Context, userID model.UserID, folder pm.FolderType)) *PrivateMessageRepo_CountByFolder_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.UserID), args[2].(pm.FolderType))
	})
	return _c
}
...
func (_m *PrivateMessageRepo) CountTypes(ctx context.Context, userID model.UserID) (pm.PrivateMessageTypeCounts, error) {
	ret := _m.Called(ctx, userID)

	var r0 pm.PrivateMessageTypeCounts
	if rf, ok := ret.Get(0).(func(context.Context, model.UserID) pm.PrivateMessageTypeCounts); ok {
		r0 = rf(ctx, userID)
	} else {
...
func (_m *PrivateMessageRepo) Create(ctx context.Context, senderID model.UserID, receiverIDs []model.UserID, relatedIDFilter pm.IDFilter, title string, content string) ([]pm.PrivateMessage, error) {
	ret := _m.Called(ctx, senderID, receiverIDs, relatedIDFilter, title, content)

	var r0 []pm.PrivateMessage
	if rf, ok := ret.Get(0).(func(context.Context, model.UserID, []model.UserID, pm.IDFilter, string, string) []pm.PrivateMessage); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, model.UserID, []model.UserID, pm.IDFilter, string, string) error); ok {
...
func (_c *PrivateMessageRepo_Create_Call) Run(run func(ctx context.Context, senderID model.UserID, receiverIDs []model.UserID, relatedIDFilter pm.IDFilter, title string, content string)) *PrivateMessageRepo_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.UserID), args[2].([]model.UserID), args[3].(pm.IDFilter), args[4].(string), args[5].(string))
	})
	return _c
}
...
func (_m *PrivateMessageRepo) List(ctx context.Context, userID model.UserID, folder pm.FolderType, offset int, limit int) ([]pm.PrivateMessageListItem, error) {
	ret := _m.Called(ctx, userID, folder, offset, limit)

	var r0 []pm.PrivateMessageListItem
	if rf, ok := ret.Get(0).(func(context.Context, model.UserID, pm.FolderType, int, int) []pm.PrivateMessageListItem); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, model.UserID, pm.FolderType, int, int) error); ok {
...
func (_c *PrivateMessageRepo_List_Call) Run(run func(ctx context.Context, userID model.UserID, folder pm.FolderType, offset int, limit int)) *PrivateMessageRepo_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.UserID), args[2].(pm.FolderType), args[3].(int), args[4].(int))
	})
	return _c
}
...
func (_m *PrivateMessageRepo) ListRelated(ctx context.Context, userID model.UserID, id model.PrivateMessageID) ([]pm.PrivateMessage, error) {
	ret := _m.Called(ctx, userID, id)

	var r0 []pm.PrivateMessage
	if rf, ok := ret.Get(0).(func(context.Context, model.UserID, model.PrivateMessageID) []pm.PrivateMessage); ok {
		r0 = rf(ctx, userID, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]pm.PrivateMessage)
