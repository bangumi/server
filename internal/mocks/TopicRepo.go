...
func (_m *TopicRepo) Get(ctx context.Context, topicType model.TopicType, limit int, offset int, id uint32) (model.Topic, error) {
...
func (_c *TopicRepo_Get_Call) Run(run func(ctx context.Context, topicType model.TopicType, limit int, offset int, id uint32)) *TopicRepo_Get_Call {
...
func (_m *TopicRepo) GetTopicsByObjectID(ctx context.Context, topicType model.TopicType, id uint32) ([]model.Topic, error) {
...
func (_c *TopicRepo_GetTopicsByObjectID_Call) Run(run func(ctx context.Context, topicType model.TopicType, id uint32)) *TopicRepo_GetTopicsByObjectID_Call {
	_c.Call.Run(func(args mock.Arguments) {
