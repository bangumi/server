...
import (
	...
	topic "github.com/bangumi/server/internal/topic"
)

// TopicRepo is an autogenerated mock type for the Repo type
...
func (_m *TopicRepo) Count(ctx context.Context, topicType topic.Type, id uint32, displays []model.TopicDisplay) (int64, error) {
	ret := _m.Called(ctx, topicType, id, displays)

	var r0 int64
	if rf, ok := ret.Get(0).(func(context.Context, topic.Type, uint32, []model.TopicDisplay) int64); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, topic.Type, uint32, []model.TopicDisplay) error); ok {
...
func (_c *TopicRepo_Count_Call) Run(run func(ctx context.Context, topicType topic.Type, id uint32, displays []model.TopicDisplay)) *TopicRepo_Count_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(topic.Type), args[2].(uint32), args[3].([]model.TopicDisplay))
	})
	return _c
}
...
func (_m *TopicRepo) CountReplies(ctx context.Context, commentType topic.CommentType, id model.TopicID) (int64, error) {
	ret := _m.Called(ctx, commentType, id)

	var r0 int64
	if rf, ok := ret.Get(0).(func(context.Context, topic.CommentType, model.TopicID) int64); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, topic.CommentType, model.TopicID) error); ok {
...
func (_c *TopicRepo_CountReplies_Call) Run(run func(ctx context.Context, commentType topic.CommentType, id model.TopicID)) *TopicRepo_CountReplies_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(topic.CommentType), args[2].(model.TopicID))
	})
	return _c
}
...
func (_m *TopicRepo) Get(ctx context.Context, topicType topic.Type, id model.TopicID) (model.Topic, error) {
	ret := _m.Called(ctx, topicType, id)

	var r0 model.Topic
	if rf, ok := ret.Get(0).(func(context.Context, topic.Type, model.TopicID) model.Topic); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, topic.Type, model.TopicID) error); ok {
...
func (_c *TopicRepo_Get_Call) Run(run func(ctx context.Context, topicType topic.Type, id model.TopicID)) *TopicRepo_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(topic.Type), args[2].(model.TopicID))
	})
	return _c
}
...
func (_m *TopicRepo) GetTopicContent(ctx context.Context, topicType topic.Type, id model.TopicID) (model.Comment, error) {
	ret := _m.Called(ctx, topicType, id)

	var r0 model.Comment
	if rf, ok := ret.Get(0).(func(context.Context, topic.Type, model.TopicID) model.Comment); ok {
		r0 = rf(ctx, topicType, id)
	} else {
...
func (_c *TopicRepo_GetTopicContent_Call) Run(run func(ctx context.Context, topicType topic.Type, id model.TopicID)) *TopicRepo_GetTopicContent_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(topic.Type), args[2].(model.TopicID))
	})
	return _c
...
func (_m *TopicRepo) List(ctx context.Context, topicType topic.Type, id uint32, displays []model.TopicDisplay, limit int, offset int) ([]model.Topic, error) {
	ret := _m.Called(ctx, topicType, id, displays, limit, offset)

	var r0 []model.Topic
	if rf, ok := ret.Get(0).(func(context.Context, topic.Type, uint32, []model.TopicDisplay, int, int) []model.Topic); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, topic.Type, uint32, []model.TopicDisplay, int, int) error); ok {
...
func (_c *TopicRepo_List_Call) Run(run func(ctx context.Context, topicType topic.Type, id uint32, displays []model.TopicDisplay, limit int, offset int)) *TopicRepo_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(topic.Type), args[2].(uint32), args[3].([]model.TopicDisplay), args[4].(int), args[5].(int))
	})
	return _c
}
...
func (_m *TopicRepo) ListReplies(ctx context.Context, commentType topic.CommentType, id model.TopicID, limit int, offset int) ([]model.Comment, error) {
	ret := _m.Called(ctx, commentType, id, limit, offset)

	var r0 []model.Comment
	if rf, ok := ret.Get(0).(func(context.Context, topic.CommentType, model.TopicID, int, int) []model.Comment); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, topic.CommentType, model.TopicID, int, int) error); ok {
...
func (_c *TopicRepo_ListReplies_Call) Run(run func(ctx context.Context, commentType topic.CommentType, id model.TopicID, limit int, offset int)) *TopicRepo_ListReplies_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(topic.CommentType), args[2].(model.TopicID), args[3].(int), args[4].(int))
	})
	return _c
}
