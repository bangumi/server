...
func (_m *PersonService) GetByIDs(ctx context.Context, ids []model.PersonID) (map[model.PersonID]model.Person, error) {
...
func (_c *PersonService_GetByIDs_Call) Run(run func(ctx context.Context, ids []model.PersonID)) *PersonService_GetByIDs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]model.PersonID))
	})
	return _c
...
func (_c *PersonService_GetByIDs_Call) Return(_a0 map[model.PersonID]model.Person, _a1 error) *PersonService_GetByIDs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

// GetCharacterRelated provides a mock function with given fields: ctx, subjectID
func (_m *PersonService) GetCharacterRelated(ctx context.Context, subjectID model.CharacterID) ([]domain.PersonCharacterRelation, error) {
...
func (_c *PersonService_GetCharacterRelated_Call) Run(run func(ctx context.Context, subjectID model.CharacterID)) *PersonService_GetCharacterRelated_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *PersonService) GetSubjectRelated(ctx context.Context, subjectID model.SubjectID) ([]domain.SubjectPersonRelation, error) {
	ret := _m.Called(ctx, subjectID)
