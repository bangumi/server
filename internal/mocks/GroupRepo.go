...
import (
	...
	group "github.com/bangumi/server/internal/group"
	mock "github.com/stretchr/testify/mock"

	model "github.com/bangumi/server/internal/model"
)

// GroupRepo is an autogenerated mock type for the Repo type
...
func (_m *GroupRepo) CountMembersByID(ctx context.Context, id model.GroupID, memberType group.MemberType) (int64, error) {
	ret := _m.Called(ctx, id, memberType)

	var r0 int64
	if rf, ok := ret.Get(0).(func(context.Context, model.GroupID, group.MemberType) int64); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, model.GroupID, group.MemberType) error); ok {
...
func (_c *GroupRepo_CountMembersByID_Call) Run(run func(ctx context.Context, id model.GroupID, memberType group.MemberType)) *GroupRepo_CountMembersByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.GroupID), args[2].(group.MemberType))
	})
	return _c
}
...
func (_m *GroupRepo) ListMembersByID(ctx context.Context, id model.GroupID, memberType group.MemberType, limit int, offset int) ([]model.GroupMember, error) {
	ret := _m.Called(ctx, id, memberType, limit, offset)

	var r0 []model.GroupMember
	if rf, ok := ret.Get(0).(func(context.Context, model.GroupID, group.MemberType, int, int) []model.GroupMember); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, model.GroupID, group.MemberType, int, int) error); ok {
...
func (_c *GroupRepo_ListMembersByID_Call) Run(run func(ctx context.Context, id model.GroupID, memberType group.MemberType, limit int, offset int)) *GroupRepo_ListMembersByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.GroupID), args[2].(group.MemberType), args[3].(int), args[4].(int))
	})
	return _c
}
