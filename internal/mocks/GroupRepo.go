...
func (_e *GroupRepo_Expecter) CountMembersByID(ctx any, id any, memberType any) *GroupRepo_CountMembersByID_Call {
...
//  - ctx context.Context
//  - name string
func (_e *GroupRepo_Expecter) GetByName(ctx any, name any) *GroupRepo_GetByName_Call {
...
//  - limit int
//  - offset int
func (_e *GroupRepo_Expecter) ListMembersByID(ctx any, id any, memberType any, limit any, offset any) *GroupRepo_ListMembersByID_Call {
