...
func (_e *CharacterRepo_Expecter) Get(ctx any, id any) *CharacterRepo_Get_Call {
...
func (_e *CharacterRepo_Expecter) GetByIDs(ctx any, ids ...any) *CharacterRepo_GetByIDs_Call {
...
func (_e *CharacterRepo_Expecter) GetPersonRelated(ctx any, personID any) *CharacterRepo_GetPersonRelated_Call {
...
func (_e *CharacterRepo_Expecter) GetSubjectRelated(ctx any, subjectID any) *CharacterRepo_GetSubjectRelated_Call {
