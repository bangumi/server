...
func (i indexDo) Returning(value any, columns ...string) *indexDo {
...
func (i indexDo) ScanByPage(result any, offset int, limit int) (count int64, err error) {
	count, err = i.Count()
	if err != nil {
		return
	}
...
func (i indexDo) Scan(result any) (err error) {
