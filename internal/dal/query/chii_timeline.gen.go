...
func newTimeLine(db *gorm.DB) timeLine {
	...
	_timeLine.UID = field.NewUint32(tableName, "tml_uid")
	...
	_timeLine.Memo = field.NewField(tableName, "tml_memo")
	_timeLine.Img = field.NewField(tableName, "tml_img")
...
func (t timeLineDo) ReadDB(ctx context.Context) *timeLineDo {
	return t.WithContext(ctx).Clauses(dbresolver.Read)
}

func (t timeLineDo) WriteDB(ctx context.Context) *timeLineDo {
