...
func newSubjectTopicComment(db *gorm.DB) subjectTopicComment {
	_subjectTopicComment := subjectTopicComment{}

	_subjectTopicComment.subjectTopicCommentDo.UseDB(db)
	...
	_subjectTopicComment.MentionedID = field.NewUint32(tableName, "sbj_pst_mid")
...
func (s *subjectTopicComment) updateTableName(table string) *subjectTopicComment {
	...
	s.MentionedID = field.NewUint32(table, "sbj_pst_mid")
...
func (s *subjectTopicComment) fillFieldMap() {
	...
	s.fieldMap["sbj_pst_mid"] = s.MentionedID
