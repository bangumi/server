...
func newIndexComment(db *gorm.DB) indexComment {
	...
	_indexComment.Dateline = field.NewUint32(tableName, "idx_pst_dateline")
...
func (i *indexComment) updateTableName(table string) *indexComment {
	...
	i.Dateline = field.NewUint32(table, "idx_pst_dateline")
...
func (i *indexComment) fillFieldMap() {
	...
	i.fieldMap["idx_pst_dateline"] = i.Dateline
