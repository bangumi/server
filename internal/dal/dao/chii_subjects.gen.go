...
type Subject struct {
	...
	TypeID      uint8        `gorm:"column:subject_type_id;type:smallint(6) unsigned;not null;index:subject_idx_cn,priority:2;index:subject_type_id,priority:1;index:order_by_name,priority:2;index:browser,priority:2;default:0" json:"subject_type_id"`
	...
	Series      bool         `gorm:"column:subject_series;type:tinyint(1) unsigned;not null;index:subject_series,priority:1;index:order_by_name,priority:3;index:browser,priority:3;default:0" json:"subject_series"`
	SeriesEntry uint32       `gorm:"column:subject_series_entry;type:mediumint(8) unsigned;not null;index:subject_series_entry,priority:1;default:0" json:"subject_series_entry"`
	...
	Ban         uint8        `gorm:"column:subject_ban;type:tinyint(1) unsigned;not null;index:subject_ban,priority:1;index:order_by_name,priority:1;index:browser,priority:1;default:0" json:"subject_ban"`
