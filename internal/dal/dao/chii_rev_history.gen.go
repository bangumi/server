...
type RevisionHistory struct {
	...
	CreatorID model.UserID `gorm:"column:rev_creator;type:mediumint(8) unsigned;not null;index:rev_crt_creator,priority:1;index:rev_id,priority:3" json:"rev_creator"`
