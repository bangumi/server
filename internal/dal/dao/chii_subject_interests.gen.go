...
type SubjectCollection struct {
	...
	WishAt      uint32          `gorm:"column:interest_wish_dateline;type:int(10) unsigned;not null" json:"interest_wish_dateline"`
	DoingAt     uint32          `gorm:"column:interest_doing_dateline;type:int(10) unsigned;not null;index:top_subject,priority:3" json:"interest_doing_dateline"`
	DoneAt      uint32          `gorm:"column:interest_collect_dateline;type:int(10) unsigned;not null;index:interest_collect_dateline,priority:1;index:subject_collect,priority:4;index:user_collect_type,priority:5" json:"interest_collect_dateline"`
	OnHoldAt    uint32          `gorm:"column:interest_on_hold_dateline;type:int(10) unsigned;not null" json:"interest_on_hold_dateline"`
	DroppedAt   uint32          `gorm:"column:interest_dropped_dateline;type:int(10) unsigned;not null" json:"interest_dropped_dateline"`
	UpdatedAt   uint32          `gorm:"column:interest_lasttouch;type:int(10) unsigned;not null;index:interest_lasttouch,priority:1;index:subject_lasttouch,priority:3;index:subject_comment,priority:4;index:interest_uid_2,priority:3" json:"interest_lasttouch"`
