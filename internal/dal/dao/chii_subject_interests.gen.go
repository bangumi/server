...
type SubjectCollection struct {
	...
	SubjectType     uint8  `gorm:"column:interest_subject_type;type:smallint(6) unsigned;not null;index:interest_subject_type,priority:1;index:tag_subject_id,priority:1;index:user_collects,priority:1;index:user_collect_type,priority:1;index:top_subject,priority:2;index:user_collect_latest,priority:1;default:0" json:"interest_subject_type"`
	Rate            uint8  `gorm:"column:interest_rate;type:tinyint(3) unsigned;not null;index:interest_rate,priority:1;index:subject_rate,priority:2;default:0" json:"interest_rate"`
	Type            uint8  `gorm:"column:interest_type;type:tinyint(1) unsigned;not null;index:interest_subject_id,priority:2;index:interest_type,priority:1;index:tag_subject_id,priority:2;index:subject_collect,priority:2;index:user_collect_type,priority:2;index:user_collect_latest,priority:2;index:interest_type_2,priority:1;default:0" json:"interest_type"`
	...
	DoingDateline   int32  `gorm:"column:interest_doing_dateline;type:int(10) unsigned;not null;index:top_subject,priority:3" json:"interest_doing_dateline"`
	CollectDateline int32  `gorm:"column:interest_collect_dateline;type:int(10) unsigned;not null;index:interest_collect_dateline,priority:1;index:subject_collect,priority:4;index:user_collect_type,priority:5" json:"interest_collect_dateline"`
