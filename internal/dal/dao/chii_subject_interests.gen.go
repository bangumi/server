...
type SubjectCollection struct {
	...
	Lasttouch       uint32 `gorm:"column:interest_lasttouch;type:int(10) unsigned;not null;index:interest_lasttouch,priority:1;index:subject_lasttouch,priority:3;index:subject_comment,priority:4;index:interest_uid_2,priority:3;default:0" json:"interest_lasttouch"`
