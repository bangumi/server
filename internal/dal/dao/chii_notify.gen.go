...
type Notification struct {
	...
	Status      model.NotificationStatus  `gorm:"column:nt_status;type:tinyint(1) unsigned;not null;default:1"`
	Type        model.NotificationType    `gorm:"column:nt_type;type:tinyint(3) unsigned;not null"`
	FieldID     model.NotificationFieldID `gorm:"column:nt_mid;type:mediumint(8) unsigned;not null"` // ID in notify_field
