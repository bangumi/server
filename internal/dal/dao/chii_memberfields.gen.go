...
type MemberField struct {
	...
	Site      string `gorm:"column:site;type:varchar(75);not null;default:''" json:"site"`
	Location  string `gorm:"column:location;type:varchar(30);not null;default:''" json:"location"`
