...
func newEpisodeComment(db *gorm.DB, opts ...gen.DOOption) episodeComment {
	...
	_episodeComment.PostID = field.NewUint32(tableName, "ep_pst_id")
	_episodeComment.FieldID = field.NewUint32(tableName, "ep_pst_mid")
	_episodeComment.UserID = field.NewUint32(tableName, "ep_pst_uid")
	_episodeComment.RelatedMessageID = field.NewUint32(tableName, "ep_pst_related")
	_episodeComment.CreatedTime = field.NewInt32(tableName, "ep_pst_dateline")
...
func (e *episodeComment) updateTableName(table string) *episodeComment {
	...
	e.PostID = field.NewUint32(table, "ep_pst_id")
	e.FieldID = field.NewUint32(table, "ep_pst_mid")
	e.UserID = field.NewUint32(table, "ep_pst_uid")
	e.RelatedMessageID = field.NewUint32(table, "ep_pst_related")
	e.CreatedTime = field.NewInt32(table, "ep_pst_dateline")
...
func (e episodeComment) Columns(cols ...field.Expr) gen.Columns {
	return e.episodeCommentDo.Columns(cols...)
}
...
func (e *episodeComment) fillFieldMap() {
	...
	e.fieldMap["ep_pst_id"] = e.PostID
	e.fieldMap["ep_pst_mid"] = e.FieldID
	e.fieldMap["ep_pst_uid"] = e.UserID
	e.fieldMap["ep_pst_related"] = e.RelatedMessageID
