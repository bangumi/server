...
func newIndexComment(db *gorm.DB, opts ...gen.DOOption) indexComment {
	_indexComment := indexComment{}

	_indexComment.indexCommentDo.UseDB(db, opts...)
	...
	_indexComment.PostID = field.NewUint32(tableName, "idx_pst_id")
	_indexComment.FieldID = field.NewUint32(tableName, "idx_pst_mid")
	_indexComment.UserID = field.NewUint32(tableName, "idx_pst_uid")
	_indexComment.RelatedMessageID = field.NewUint32(tableName, "idx_pst_related")
	_indexComment.CreatedTime = field.NewInt32(tableName, "idx_pst_dateline")
...
func (i *indexComment) updateTableName(table string) *indexComment {
	...
	i.PostID = field.NewUint32(table, "idx_pst_id")
	i.FieldID = field.NewUint32(table, "idx_pst_mid")
	i.UserID = field.NewUint32(table, "idx_pst_uid")
	i.RelatedMessageID = field.NewUint32(table, "idx_pst_related")
	i.CreatedTime = field.NewInt32(table, "idx_pst_dateline")
...
func (i indexComment) Columns(cols ...field.Expr) gen.Columns {
	return i.indexCommentDo.Columns(cols...)
}
...
func (i *indexComment) fillFieldMap() {
	...
	i.fieldMap["idx_pst_id"] = i.PostID
	i.fieldMap["idx_pst_mid"] = i.FieldID
	i.fieldMap["idx_pst_uid"] = i.UserID
	i.fieldMap["idx_pst_related"] = i.RelatedMessageID
...
func (i indexComment) clone(db *gorm.DB) indexComment {
	i.indexCommentDo.ReplaceConnPool(db.Statement.ConnPool)
	return i
}

func (i indexComment) replaceDB(db *gorm.DB) indexComment {
...
func (i indexCommentDo) Session(config *gorm.Session) *indexCommentDo {
