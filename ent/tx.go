...
func (tx *Tx) init() {
	tx.CharacterFields = NewCharacterFieldsClient(tx.config)
	tx.Person = NewPersonClient(tx.config)
	tx.PersonCsIndex = NewPersonCsIndexClient(tx.config)
}
...
// applies a query, for example: CharacterFields.QueryXXX(), the query will be executed
