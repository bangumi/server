...
func (_m *MockPersonRepo) GetCharacterRelated(ctx context.Context, subjectID uint32) (model.Person, model.PersonSubjectRelation, error) {
...
func (_c *MockPersonRepo_GetCharacterRelated_Call) Return(_a0 model.Person, _a1 model.PersonSubjectRelation, _a2 error) *MockPersonRepo_GetCharacterRelated_Call {
